...
if not st.session_state.df.empty:
    ...
    with tab2:
        with st.expander("Instruction 📜"):
            ...
            ☑️ Если да, активируйте чекбокс "With salary?".
            
            2️⃣ После активации, введите минимальное значение зарплаты 💰 и 
            сколько вакансий 🧮 вы хотите рассмотреть (максимум до 500).

            3️⃣ Введите свой логин 🔑 и пароль 🔐

            4️⃣ 🔍 Нажмите кнопку "Generate list", чтобы увидеть список вакансий.

            5️⃣ 📤 Готовы отправить? Нажмите кнопку "SEND RESUME".

            🔄 Альтернативный вариант:

            1️⃣ 📤 Загрузите свой список вакансий. Убедитесь, что у вас только один столбец с "apply_alternate_url" и не более 500 строк (не считая заголовка).
        ...
        if "age_slider_value" not in st.session_state:
            ...
            with c2:
                num_vacanc = st.number_input('Vacancies quantity', value = 500, max_value = 500)
