...
if not st.session_state.df.empty:
    ...
    with tab2:
        with st.expander("Instruction 📥"):
            st.markdown('''1️⃣ 📌 Прежде всего, решите, хотите ли вы фильтровать вакансии по зарплате:

☑️ Если да, активируйте чекбокс "Указана ли ЗП?".
💰 После активации, введите минимальное значение зарплаты.
2️⃣ 🧮 Выберите, сколько вакансий вы хотите рассмотреть (максимум до 200).

3️⃣ 🔍 Нажмите кнопку "Generate list", чтобы увидеть список вакансий.

4️⃣ 📤 Готовы отправить? Нажмите кнопку "SEND RESUME".

🔄 Альтернативный вариант:

📤 Загрузите свой список вакансий. Убедитесь, что у вас только один столбец с "apply_alternate_url" и не более 200 строк (не считая заголовка).
🚀 Нажмите "SEND RESUME" для отправки резюме.'''
