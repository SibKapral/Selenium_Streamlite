...
if not st.session_state.df.empty:
    ...
    with tab2:
        with st.expander("Instruction 📥"):
            ...
            сколько вакансий 🧮 вы хотите рассмотреть (максимум до 200).
            ...
            1️⃣ 📤 Загрузите свой список вакансий. Убедитесь, что у вас только один столбец с "apply_alternate_url" и не более 200 строк (не считая заголовка).
